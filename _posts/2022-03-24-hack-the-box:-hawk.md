...
go: cannot find main module, but found .git/config in /home/kali/go-openssl-bruteforce
        to create a module there, run:
        go mod init
                                                                                                                                                                                             
┌──(thatvirdiguy㉿kali)-[~/go-openssl-bruteforce]
└─$ go mod init                                                                                                                                                                          1 ⨯
go: cannot determine module path for source directory /home/kali/go-openssl-bruteforce (outside GOPATH, module path must be specified)
...
┌──(thatvirdiguy㉿kali)-[~/go-openssl-bruteforce]
└─$ go mod init /home/kali/go-openssl-bruteforce                                                                                                                                         1 ⨯
go: malformed module path "/home/kali/go-openssl-bruteforce": empty path element
                                                                                                                                                                                             
┌──(thatvirdiguy㉿kali)-[~/go-openssl-bruteforce]
└─$ go mod init home/kali/go-openssl-bruteforce                                                                                                                                          1 ⨯
go: creating new go.mod: module home/kali/go-openssl-bruteforce
